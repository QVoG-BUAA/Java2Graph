package cn.edu.j2graph.qvog.j2graph.j2cpg.ast;
...
public class TinyPDGASTVisitor extends NaiveASTFlattener {
    ...
    public boolean visit(final InstanceofExpression node) {
        ...
        String text = left.getText() +
                " instanceof " +
                right.getText();
        instanceofExpression.setText(text);
    ...
    public boolean visit(final MethodDeclaration node) {
        ...
        final String className = String.valueOf(((TypeDeclaration) tmpNode).getName());
    ...
    public boolean visit(final MethodInvocation node) {
        ...
        if (null != node.getExpression()) {
            ...
            methodInvocation.addExpression(expression);
            text.append(expression.getText());
            text.append(".");
        }
    ...
    public boolean visit(final ParenthesizedExpression node) {
        ...
        String text = "(" +
                expression.getText() +
                ")";
        parenthesizedExpression.setText(text);
    ...
    public boolean visit(final PostfixExpression node) {
        ...
        String text = operand.getText() +
                operator.getText();
        postfixExpression.setText(text);
    ...
    public boolean visit(final SynchronizedStatement node) {
        ...
        if (!this.stack.isEmpty() && this.stack.peek() instanceof BlockInfo) {
            ...
            String text = "synchronized (" +
                    ...
                    ") " +
                    body.getText();
            synchronizedBlock.setText(text);
        }
